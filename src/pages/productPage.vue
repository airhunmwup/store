                                ...
                                <div class="tab-content text-left">
                                    <div class="featured owl-carousel owl-theme">
                                        <div class="content-category">
                                            <div class="content-img">
                                                <a href="product-grid-sidebar-left.html">
                                                    <img class="img-fluid" src="img/product/27.jpg" alt="Side Table" title="Side Table">
                                                </a>
                                            </div>
                                        ...
                                        <div class="content-category">
                                            <div class="content-img">
                                                <a href="product-grid-sidebar-left.html">
                                                    <img class="img-fluid" src="img/product/28.jpg" alt="Side Table" title="Side Table">
                                                </a>
                                            </div>
                                            <div class="info-category">
                                                <b>
                                        ...
                                        <div class="content-category">
                                            <div class="content-img">
                                                <a href="product-grid-sidebar-left.html">
                                                    <img class="img-fluid" src="img/product/29.jpg" alt="Side Table" title="Side Table">
                                                </a>
                                            </div>
                                            <div class="info-category">
                                                <b>
                                        ...
                                        <div class="content-category">
                                            <div class="content-img">
                                                <a href="product-grid-sidebar-left.html">
                                                    <img class="img-fluid" src="img/product/30.jpg" alt="Side Table" title="Side Table">
                                                </a>
                                            </div>
                                            <div class="info-category">
                                                <b>
                                        ...
                                        <div class="content-category">
                                            <div class="content-img">
                                                <a href="product-grid-sidebar-left.html">
                                                    <img class="img-fluid" src="img/product/31.jpg" alt="Side Table" title="Side Table">
                                                </a>
                                            </div>
                                            <div class="info-category">
                                                <b>
                                        ...
                                        <div class="content-category">
                                            <div class="content-img">
                                                <a href="product-grid-sidebar-left.html">
                                                    <img class="img-fluid" src="img/product/32.jpg" alt="Side Table" title="Side Table">
                                                </a>
                                            </div>
                                            <div class="info-category">
                                                <b>
                                        ...
                                        <div class="content-category">
                                            <div class="content-img">
                                                <a href="product-grid-sidebar-left.html">
                                                    <img class="img-fluid" src="img/product/33.jpg" alt="Side Table" title="Side Table">
                                                </a>
                                            </div>
                                            <div class="info-category">
                                                <b>
                                            ...
                                            <div class="js-product-list-top ">
                                                <div class="d-flex justify-content-around row">
                                                    ...
                                                    <div class="page-list text-center">
                                                       <span><a rel="prev" href="#" class="previous disabled js-search-link">
                                                                    Previous
                                                                </a>
                                                            </span>
