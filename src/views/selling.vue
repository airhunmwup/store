  ...
  <span class="h4 font-weight-bold text-light align-text-bottom pt-4">Top selling articles for you </span><span class="h2 pl-4"> <i class="fa fa-2xl d-xs-none text-light fa-hand-o-right"></i><i class="fa fa-2xl d-lg-none d-md-none d-sm-none text-light fa-hand-o-down"></i></span>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 p-3">
                                        <router-link
                                            ...
                                            data-target=".navbar-collapse"
                                          ><div class="content card shadow p-3 border">
                                            <p class="text-primary pt-5 pb-2 h4 font-weight-bold text-center"> Creating a listing</p>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 p-3">
                                        <router-link
                                            ...
                                            data-target=".navbar-collapse"
                                          ><div class="content card shadow p-3 border">
                                            <p class="text-primary pt-5 pb-2 h4 font-weight-bold text-center"> How sellers can cancel an order</p>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 p-3">
                                        <router-link
                                          ...
                                          ><div class="content card p-3 border">
                                            <p class="text-primary pt-5 pb-2 h4 font-weight-bold text-center"> Manage returns, missing items, and...</p>
