    ...
    <div class="container pb-5">
      <div class="row align-content-center">
        <div class="pb-2 text-center">
          <p class="h4 text-dark">Continue creating an account</p>
        </div>

        <p class="pb-4 text-primary text-center">
          Add address you want to use on the store? 
        </p>
                ...
                <div class="col-sm-12 col-lg-4 col-md-4">
                            <form>
                              ...
                              disabled>
                                ...
                                title="Continue"
                              >
                                <button type="button" class="btn text-sm btn-warning border btn-block" @click.prevent="addAddress">Add address</button></router-link
                              >
                                        </div>
                            </form>
                </div>
