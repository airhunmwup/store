...
<!--Password modify-->
                            ...
                            <a class="cateItem justify-content-end" 
                              data-toggle="collapse"
                              data-target="#passwordmodify" href="#"><span class="font-weight-bold h4 underline justify-content-end"
                                            ><i class="fa fa-angle-right fa-x2"></i></span
                                            ></a>
                                        </p>
                                        </td>
                                    </tr>
...
<!--Security question -->
                            ...
                            <a class="cateItem justify-content-end" 
                              data-toggle="collapse"
                              data-target="#securityquestion" href="#"><span class="font-weight-bold h4 underline justify-content-end"
                                            ><i class="fa fa-angle-right fa-x2"></i></span
                                            ></a>
                                        </p>
                                        </td>
