  ...
  <div>
    ...
    <div class="appion">
      ...
      <ul class="hs full">
        <router-link
          ...
          title="Home"
        >
          <li class="item text-dark">Categories 1</li></router-link
        >
    ...
    <div class="main-content">
      ...
      <section class="">
          ...
          <div class="content">
            <div class="title-product col-12">
              ...
              <div class="box col-12">
                <h2 class="">Today's pick</h2>
                <p class="text-dark text-right"><router-link
          to="/Product page"
          data-toggle="collapse"
          data-target=".navbar-collapse"
          title="Home"
        >
                  <b class=""> see all </b>
                  <b class="fa fa-caret-square-o-right"></b></router-link>
                </p>
              </div>
              <br />
        ...
        >
                  <div class="content">
                    ...
                    <div class="content p-3 font-weight-bold tex-2 border-r-2 border-l-2 border-b-2">
