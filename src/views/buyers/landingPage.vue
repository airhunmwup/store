...
<div class="card-body">
      <div class="row justify-content-center">
        <div class="col-lg-3 col-md-3 col-sm-lg d-xs-none card">
          <ul class="list-group list-group-flush">
            <router-link
              v-for="category of setCategoryList"
              :key="category.id"
              to="/Categorie page"
              class="dropright"
              data-toggle="collapse"
              data-target=".navbar-collapse"
            >
              <li class="font-weight-bold list-group-item text-xs text-dark">
                {{ category.cat_name }}
              </li>
            </router-link>
          </ul>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 row">
          ...
          <div class="container pt-2 card">
            <div class="row">
              <div class="col-lg-6 col-sm-12">
                <img
                  src="img/banner/bannerrejee1.jpg"
                  class="card-img-top"
                  style="height: 8rem"
                  alt="Product"
                />
              ...
              <div class="col-lg-6 col-sm-12">
                <img
                  src="img/banner/bannerrejee2.webp"
                  class="card-img-top"
                  style="height: 8rem"
                  alt="Product"
                />
            ...
            <div class="footer-top">
              <div class="row pl-4">
                ...
                <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                  <div class="block">
                    <div class="block-content">
                      <div class="title-block text-light">
                        About REJEE Stores
                      </div>
                      <ul>
                        <li class="underline">
                  ...
                  <div class="block">
                    <div class="block-content">
                      ...
                      <ul>
                        <li>
                          <a
                            href="https://www.facebook.com/REJEELtd"
                            class="text-light"
                        ...
                        <li>
                          <a
                            href="https://instagram.com/REJEEcompany"
                            class="text-light"
                        ...
                        <li>
                          <a
                            href="https://twitter.com/REJEEcompany"
                            class="text-light"
...
export default {
  ...
  computed: mapState(["setCategoryList"]),
  mounted() {
