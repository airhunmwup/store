<template>
  <!-- main content -->
  <div class="justify-content-center text-sm pb-4">
    <div class="row">
...
<!--recently viewed-->
                <div class="row col-sm-12 p-3 col-lg-8 pb-4 col-md-8">
                  <span class="text h4 font-weight-bold p-3 font-weight-normal">
                  Add a new address
                  </span>
                          ...
                          >
                            <form>
                              ...
                              disabled>
                                ...
                                title="Continue"
                              >
                                <button type="button" class="btn text-sm btn-warning border-secondary" @click.prevent="addAddress">Add address</button></router-link
                              >
                                        </div>
                            </form>
                          </div>
