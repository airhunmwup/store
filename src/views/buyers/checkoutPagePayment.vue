        ...
        <!-- main -->
          <div class="container">
                      ...
                      <div class="checkout-personal-step">
                        ...
                        <div class="checkout-personal-step">
                          <h3 class="step-title h5">
                            Shipping Addresse. <i class="fa fa-check font-weight-normal text-success"></i>
                          </h3>
                        </div>
                        <div class="checkout-personal-step text-dark h5">
                              ...
                              <div class="row pt-4">
                                ...
                                <div class="form-group">
                                  <input
                                    ...
                                    name="firstname"
                                    type="text"
                                    placeholder="Name as show on card"
                                  />
                                </div>
                                      <p class="text-dark text-sm"
                                        >Card number
                                ...
                                <select
                                    class="
                                    col-lg-12 col-md-12 col-sm-12 form-control border-b-2 border-t-0 border-l-0 border-r-0
                                    "
                                    name="month"
                                    type="text"
                                    value=""
                ...
                <option value="23">2023</option>
                                ...
                                />
                                      <p class="text-dark text-sm"
                                        >Security code found on your card
                                      </p>
                                </div>
                              </div>
                                            <div class="p-3">
