<template>
  <div class="container">
        ...
        <div class="col-sm-4">
          <div class="card">
            ...
            <p class="p-2">
              <button
                type="button"
                class="col-6 border btn-sm pr-3 btn btn-light"
              >
                Edit
              </button>
              <button type="button" class="col-6 btn-sm border btn btn-light">
                Delete
              </button>
            </p>
          </div>
    ...
    <div v-show="!this.$store.state.currentUser.id" id="AddAddress" class="row">
      <div class="p-4 col-md-8 check-info">
        <div class="checkout-personal-step">
          <h3 class="step-title text-dark h5">Add a new address</h3>
        </div>
        <div class="content">
              ...
              <form action="#" class="js-customer-form" method="post">
                <div>
                  <div class="form-group row">
                    <label class="title text-dark font-weight-bold"
