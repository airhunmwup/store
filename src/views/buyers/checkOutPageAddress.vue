                ...
                <div class="m-2 col-sm-4">
                    ...
                    <div class="card">
                        ...
                        <p class="p-2">
                            ...
                            <router-link class="" to="/checkoutpayment" data-toggle="collapse" data-target=".navbar-collapse" title="Home"><button type="button" class="btn border text-sm btn-sm btn-warning btn-block">Deliver to this address</button>
                        ...
                        <div class="tab-pane fade in active show col-md-8 col-lg-8 col-sm-8" id="checkout-guest-form" role="tabpanel">
                            ...
                            <form action="#" class="js-customer-form" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input class="form-control border-secondary" type="text" placeholder="" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <input class="form-control border-secondary" type="tel" placeholder="" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <input class="form-control border-secondary" type="text" placeholder="Enter your area postcode" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <input class="form-control border-secondary" type="text" placeholder="type your address" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <p class="text-dark text-sm"> Add delivery instructions (optional)
    
                                    </p>
    
                                    <p class="text-dark text-xs">Do we need additional instructions to find this address?
    
                                    </p>
    
    
    
                                    <textarea class="form-control border-secondary text-xs" type="text" row="11" placeholder="Provide details such as building description, a nearby landmark, or other navigation instruction"></textarea>
    
                                </div>
    
                                <div class="form-group row">
    
                                    <p class="text-dark text-xs">Do we need a security code or a call box number to access this building?
    
                                    </p>
    
    
    
                                    <input class="form-control border-secondary" type="text-sm" placeholder="1234" />
