                          ...
                          <div class="container">
                            <div class="row">
                              <div class="col-lg-10 pt-5 pl-5 pb-4 col-sm-10">
                                ...
                                <p class="h1 font-weight-bold text-dark pl-5">Resolving unpaid items with buyers</p>
                              </div>
                              <hr>
...
You don't have to contact the buyer if they haven't paid – we'll send them reminders to pay. If they don't pay after 4 calendar days, you can cancel the order.
                                ...
                                <p class="h4 font-weight-bold p-2 text-dark">Using Preferences for items awaiting payment</p>
                                    <p class="text-dark p-2">
